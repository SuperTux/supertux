...
Gradient::draw(DrawingContext& context)
{
  ...
  {
      auto camera_translation = get_parent_sector()->get_camera().get_translation();
      auto sector_width = get_parent_sector()->get_width();
      auto sector_height = get_parent_sector()->get_height();
