 ...
 */
class Wind : public MovingObject, public ExposedObject<Wind, scripting::Wind> {
 public:
  ...
  std::string get_class() const { return "wind"; }
  std::string get_display_name() const { return _("Wind"); }
