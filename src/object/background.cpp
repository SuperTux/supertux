...
Background::save(Writer& writer)
{
  ...
  switch (alignment) {
    case LEFT_ALIGNMENT:
      writer.write("alignment", "left", false);
      break;
    case RIGHT_ALIGNMENT:
      writer.write("alignment", "right", false);
      break;
    case TOP_ALIGNMENT:
      writer.write("alignment", "top", false);
      break;
    case BOTTOM_ALIGNMENT:
      writer.write("alignment", "bottom", false);
      break;
    case NO_ALIGNMENT:
      break;
  }
...
Background::get_settings()
{
  ...
  result.options.push_back(
      ObjectOption(MN_NUMFIELD, _("Speed x"), &speed, "speed"));
  result.options.push_back(ObjectOption(MN_NUMFIELD, _("Speed y"), &speed_y));

  ObjectOption img(MN_FILE, _("Top image"), &imagefile_top, "image-top",
                   (OPTION_VISIBLE));
...
void
Background::set_images(const std::string& name_top_,
                       const std::string& name_middle_,
