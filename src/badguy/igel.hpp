...
class Igel : public WalkingBadguy {
 public:
  ...
  std::string get_class() const { return "igel"; }
  std::string get_display_name() const { return _("Igel"); }
 ...
 private:
  Timer turn_recover_timer; /**< wait time until we will turn around again when
                               shot at */
};
