...
WalkingBadguy::WalkingBadguy(const Vector& pos,
  ...
  BadGuyNoScript(pos, sprite_name_, layer_, light_sprite_name),
...
WalkingBadguy::WalkingBadguy(const Vector& pos,
                             ...
                             int layer_,
                             const std::string& light_sprite_name) :
  BadGuyNoScript(pos, direction, sprite_name_, layer_, light_sprite_name),
  walk_left_action(walk_left_action_),
  walk_right_action(walk_right_action_),
  walk_speed(80),
  max_drop_height(-1),
...
WalkingBadguy::WalkingBadguy(const ReaderMapping& reader,
                             ...
                             int layer_,
                             const std::string& light_sprite_name) :
  BadGuyNoScript(reader, sprite_name_, layer_, light_sprite_name),
  walk_left_action(walk_left_action_),
  walk_right_action(walk_right_action_),
  walk_speed(80),
  max_drop_height(-1),
