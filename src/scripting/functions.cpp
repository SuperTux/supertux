...
std::string
translate_plural(const std::string& text, const std::string& text_plural,
                 int num)
{
...
std::string
__(const std::string& text, const std::string& text_plural, int num)
{
...
void
set_next_worldmap(const std::string& dirname, const std::string& spawnpoint)
{
