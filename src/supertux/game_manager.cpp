...
GameManager::GameManager()
    : m_world(), m_savegame(), next_worldmap(), next_spawnpoint()
{
}
...
GameManager::run_level(World* world, const std::string& level_filename)
{
  ...
  std::unique_ptr<Screen> screen(
      new LevelsetScreen(world->get_basedir(), level_filename, *m_savegame));
  ScreenManager::current()->push_screen(std::move(screen));
}

void
GameManager::run_worldmap(World* world, const std::string& worldmap_filename,
...
void
GameManager::start_worldmap(World* world, const std::string& spawnpoint,
                            const std::string& worldmap_filename)
{
...
void
GameManager::set_next_worldmap(const std::string& worldmap,
                               const std::string& spawnpoint)
{
