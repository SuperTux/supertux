      ...
      resolutions()
{
  ...
  auto magnification = add_string_select(MNID_MAGNIFICATION, _("Magnification"),
                                         &next_magnification, magnifications);
  magnification->set_help(_("Change the magnification of the game area"));

  auto aspect = add_string_select(MNID_ASPECTRATIO, _("Aspect Ratio"),
  ...
  add_toggle(MNID_CONFIRMATION_DIALOG, _("Confirmation Dialog"),
             &g_config->confirmation_dialog)
