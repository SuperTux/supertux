...
MovingObject::MovingObject(const ReaderMapping& reader)
    : GameObject(reader), bbox(), movement(), group(COLGROUP_MOVING), dest()
{
}
...
MovingObject::edit_bbox()
{
  ...
  GameObjectPtr marker1, marker2, marker3, marker4, marker5, marker6, marker7,
      marker8;
  marker1 =
      std::make_shared<Resizer>(&bbox, Resizer::LEFT_UP, Resizer::LEFT_UP);
  marker2 = std::make_shared<Resizer>(&bbox, Resizer::LEFT_UP, Resizer::NONE);
  marker3 =
      std::make_shared<Resizer>(&bbox, Resizer::LEFT_UP, Resizer::RIGHT_DOWN);
  marker4 = std::make_shared<Resizer>(&bbox, Resizer::NONE, Resizer::LEFT_UP);
  marker5 =
      std::make_shared<Resizer>(&bbox, Resizer::NONE, Resizer::RIGHT_DOWN);
  marker6 =
      std::make_shared<Resizer>(&bbox, Resizer::RIGHT_DOWN, Resizer::LEFT_UP);
  marker7 =
      std::make_shared<Resizer>(&bbox, Resizer::RIGHT_DOWN, Resizer::NONE);
  marker8 = std::make_shared<Resizer>(&bbox, Resizer::RIGHT_DOWN,
                                      Resizer::RIGHT_DOWN);
