                      ...
                      GameObject* object = NULL, MovingObject* other = NULL, const Vector& other_movement = Vector(0,0))
{
  ...
  // TODO: Find another solution for the jittering issue? See #395 ("Stacked
  // Objects "Jitter"") and #593 ("Workaround for #395").
  ...
  // TODO: Find another solution for the jittering issue? See #395 and #593.
  ...
  if(other != NULL && object != NULL) {
    ...
    if(other->get_movement() != Vector(0, 0)) {
      ...
      // TODO: Find another solution to the jittering issue? See #395 and #593.
      constraints->ground_movement += Vector(other_movement.x,
                                             jittering ? 0 : other_movement.y);
    }
  }
