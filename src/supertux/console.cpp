 ...
 * with search_prefix; Calls sq_insert_commands if search_prefix starts with
 * table_prefix+key (and value is a table/class/instance);
 */
void
...
bool
Console::consoleCommand(const std::string& /*command*/,
