...
LevelIntro::LevelIntro(const Level* level_,
    ...
    : level(level_),
      ...
      power_sprite(SpriteManager::current()->create(
...
void
LevelIntro::draw_stats_line(DrawingContext& context, int& py,
