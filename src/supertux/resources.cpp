...
FontPtr Resources::small_control_font;
...
Resources::load()
{
  ...
  if (g_debug.get_use_bitmap_fonts())
  {
    ...
    small_control_font.reset(new BitmapFont(BitmapFont::FIXED, "fonts/white-small.stf")); // TODO: Make a better-looking font for this
  }
  else
  {
    ...
    if(font != current_font)
    {
      ...
      small_control_font.reset(new TTFFont("fonts/Roboto-Regular.ttf", 8, 1.25f, 0, 0));
    }
  }
