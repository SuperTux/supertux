...
void
DrawingContext::draw_line(const Vector& pos1, const Vector& pos2,
                          const Color& color, int layer)
{
  auto request = new (obst) DrawingRequest();
...
void
DrawingContext::draw_triangle(const Vector& pos1, const Vector& pos2,
                              const Vector& pos3, const Color& color, int layer)
{
  auto request = new (obst) DrawingRequest();
