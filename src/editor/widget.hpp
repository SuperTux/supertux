...
#ifndef HEADER_SUPERTUX__HOME_INGO_PROJECTS_SUPERTUX_TRUNK_SUPERTUX_COMPONENT_HPP
#define HEADER_SUPERTUX__HOME_INGO_PROJECTS_SUPERTUX_TRUNK_SUPERTUX_COMPONENT_HPP
