...
#if 0
#ifndef HEADER_SUPERTUX_EDITOR_PARTICLE_SETTINGS_WIDGET_HPP
#define HEADER_SUPERTUX_EDITOR_PARTICLE_SETTINGS_WIDGET_HPP
...
class ParticleSettingsWidget final : public Widget
{
public:
  ParticleSettingsWidget();
...
private:
  ParticleSettingsWidget(const ParticleSettingsWidget&) = delete;
  ParticleSettingsWidget& operator=(const ParticleSettingsWidget&) = delete;
};
