...
ParticleSettingsWidget::ParticleSettingsWidget() :
  m_scrolling(),
  m_hovering(),
  m_total_region(),
  m_covered_region(),
...
void
ParticleSettingsWidget::draw(DrawingContext& context)
{
  m_rect = Rect(10, 0, 20, context.get_height());
...
void
ParticleSettingsWidget::update(float dt_sec)
{
  
}

bool
ParticleSettingsWidget::on_mouse_button_up(const SDL_MouseButtonEvent& button)
{
  m_scrolling = false;
  return false;
}
...
bool
ParticleSettingsWidget::on_mouse_button_down(const SDL_MouseButtonEvent& button)
{
...
bool
ParticleSettingsWidget::on_mouse_motion(const SDL_MouseMotionEvent& motion)
{
...
Rect
ParticleSettingsWidget::get_bar_rect()
{
