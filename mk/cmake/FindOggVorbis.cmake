...
if(WIN64)
  find_library(OGG_LIBRARY NAMES ogg_static Ogg_static libogg_static PATHS "${DEPENDENCY_FOLDER}/lib")
  find_library(VORBIS_LIBRARY NAMES vorbis_static Vorbis_static libvorbis_static PATHS "${DEPENDENCY_FOLDER}/lib")
  find_library(VORBISFILE_LIBRARY NAMES vorbisfile_static libvorbisfile_static PATHS "${DEPENDENCY_FOLDER}/lib")
else(WIN64)
